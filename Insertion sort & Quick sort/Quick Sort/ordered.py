...
files = [
    "ordered-input-1000-float.txt",
        "ordered-input-10000-float.txt",
        "ordered-input-20000-float.txt",
        "ordered-input-50000-float.txt",
        "ordered-input-75000-float.txt",
        "ordered-input-100000-float.txt"
]
